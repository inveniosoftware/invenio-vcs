...
class GenericRepository:
    ...
    Some fields might be None if they are optional and unspecified, or if the repository
    is returned via a list query rather than a get query.
    """
